"""
Django settings for fancy_block_42962 project.
...
ROOT_URLCONF = 'fancy_block_42962.urls'
...
WSGI_APPLICATION = 'fancy_block_42962.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fancy_block_42962 API",
    "DESCRIPTION": "API documentation for fancy_block_42962 App",
    "VERSION": "v1",
}
